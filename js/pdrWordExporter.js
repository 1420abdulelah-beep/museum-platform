...
App.PdrWordExporter = {
  ...
  _resolveTeamMap(data) {
    ...
    const defaultTeam = [
      { id: "admin", name: "بوعبدالله", role: "الإدارة العامة والحوكمة والصلاحيات", department: "الإدارة العامة والحوكمة", avatar: "👑" },
      { id: "Osamah", name: "أسامة السيد", role: "عضو فريق", department: "فريق التنفيذ والمحتوى", avatar: "👨‍💼" },
      { id: "abdulrahman", name: "عبدالرحمن السيد", role: "عضو فريق", department: "فريق التنفيذ والمحتوى", avatar: "👨‍💼" },
      { id: "Thamer", name: "ثامر", role: "عضو فريق", department: "فريق التنفيذ والمحتوى", avatar: "👨‍💼" },
      { id: "Anas", name: "أنس", role: "عضو فريق", department: "فريق التنفيذ والمحتوى", avatar: "👨‍💼" },
      { id: "BuOmer", name: "بوعمر", role: "عضو فريق", department: "فريق التنفيذ والمحتوى", avatar: "👨‍💼" },
      { id: "Ahmed", name: "الضياء", role: "عضو فريق", department: "فريق التنفيذ والمحتوى", avatar: "👨‍💼" },
      { id: "Designer", name: "مصمم", role: "عضو فريق", department: "فريق التصميم والتنفيذ", avatar: "🎨" }
    ];
